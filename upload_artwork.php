...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        // Insert artwork
        $stmt = $pdo->prepare("INSERT INTO Artworks (title, description, price, image_path, artist_id, status, uploaded_at) 
                              VALUES (?, ?, ?, ?, ?, 'available', NOW())");
        $stmt->execute([$title, $description, $price, $image_path, $_SESSION['user_id']]);
