        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div id="reviewSection" class="mt-4" style="cursor: pointer;" data-bs-toggle="modal" data-bs-target="#reviewsModal">
                    <h3>Reviews</h3>
                    <div class="mb-3">
                        <span class="h4"><?php echo number_format($avg_rating, 1); ?></span>
                    ...
                    <?php if(isset($_SESSION['user_id']) && !$user_rated && $artwork['artist_id'] !== $_SESSION['user_id']): ?>

                    <?php elseif($user_rated): ?>
                        <p class="text-muted">You've already rated this artwork.</p>
                    <?php endif; ?>
                </div>
                <?php if(isset($_SESSION['user_id']) && $artwork['artist_id'] !== $_SESSION['user_id']): ?>
